...
public class AccountsInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFBUserName = mSettings.getString("fbusername", "");
        ...
        if (mFBUserName.isEmpty()) {
            ...
            String v = mSettings.getString("fbid","");
            mFbAvatar.setProfileId(v);
            mAccoutName.setText(mFBUserName);
